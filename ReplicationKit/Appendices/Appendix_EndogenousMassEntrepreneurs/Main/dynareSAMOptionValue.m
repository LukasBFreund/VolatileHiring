...
M_.endo_names_long = char(M_.endo_names_long, 'Mass of entrepreneurs');
M_.endo_names = char(M_.endo_names, 'g');
M_.endo_names_tex = char(M_.endo_names_tex, '{g}');
M_.endo_names_long = char(M_.endo_names_long, 'Probability of entrepreneurial entry');
...
M_.equations_tags = {
  ...
  16 , 'name' , 'Entry of entrepreneurs' ;
  18 , 'name' , 'Aggregate productivity' ;
  19 , 'name' , 'Aggregate productivity volatility' ;
  20 , 'name' , 'Output' ;
  21 , 'name' , 'Value of matched entrepreneur at steady state cut-off level' ;
  23 , 'name' , 'Value of entrepreneur leaving without match' ;
};
...
save('Output\IRFs\IRFs_SaMOptionValue_Extension_Upsilon_Spc', 'vEMAS', 'vNames', 'vNames_Andreasen', 'mIRFProp_zUncertainty_EMAS', 'mIRFProp_Andreasen_zVol_EMAS','mIRFProp_Andreasen_z_EMAS','mIRFProp_Andreasen_Order1_z_EMAS','mIRFProp_Order1_z_EMAS','mIRFProp_Andreasen_Order3_z_EMAS'); 
