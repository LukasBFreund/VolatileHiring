...
// Version with endogenous mass of potential entrepreneurs.
...
// In this version, Upsilon is endogenous
    Upsilon ${\Upsilon}$              (long_name='Mass of entrepreneurs')
    g       ${g}$                     (long_name='Probability of entrepreneurial entry')
...
% Again, a couple new ones here
set_param_value('mu',sPar.mu);
set_param_value('iota',sPar.iota);
...
save('Output\IRFs\IRFs_SaMOptionValue_Extension_Upsilon_Spc', 'vEMAS', 'vNames', 'vNames_Andreasen', 'mIRFProp_zUncertainty_EMAS', 'mIRFProp_Andreasen_zVol_EMAS','mIRFProp_Andreasen_z_EMAS','mIRFProp_Andreasen_Order1_z_EMAS','mIRFProp_Order1_z_EMAS','mIRFProp_Andreasen_Order3_z_EMAS'); %,'sIRFDynare')
