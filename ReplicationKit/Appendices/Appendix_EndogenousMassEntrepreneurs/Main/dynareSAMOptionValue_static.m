...
T192 = (-((1-params(5))*params(9)/(1-(1-params(4))*params(1))));
lhs =y(4);
...
residual(6)= lhs-rhs;
lhs =y(14);
rhs =(1-params(5))*params(9)*y(12)/(1-(1-params(4))*params(1))+y(20);
residual(7)= lhs-rhs;
lhs =y(20);
rhs =(1-params(5))*(params(9)*y(7)-params(7))+params(1)*(1-params(4))*y(20);
residual(8)= lhs-rhs;
lhs =y(15);
rhs =(1-params(5))*params(9)*y(13)/(1-(1-params(4))*params(1))+y(21);
residual(9)= lhs-rhs;
lhs =y(21);
...
residual(12)= lhs-rhs;
lhs =y(11);
rhs =1-(y(12)-params(18))/(params(17)-params(18));
residual(13)= lhs-rhs;
lhs =y(13);
rhs =0.5*(y(12)+params(17));
residual(14)= lhs-rhs;
lhs =y(5);
rhs =y(11)*(y(18)-(1-params(4))*y(2));
residual(15)= lhs-rhs;
lhs =y(19);
rhs =y(18)^(-params(20));
residual(16)= lhs-rhs;
...
residual(20)= lhs-rhs;
lhs =y(17);
rhs =(1-params(5))*params(9)*(y(12))/(1-(1-params(4))*params(1))+y(23);
residual(21)= lhs-rhs;
lhs =y(23);
rhs =(1-params(5))*(params(9)*y(7)-params(7))+params(1)*(1-params(4))*y(23);
residual(22)= lhs-rhs;
lhs =y(22);
rhs =params(1)*y(16);
residual(23)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(8,20)=1-(1-params(4))*params(1);
  g1(9,13)=T192;
  g1(9,15)=1;
  g1(9,21)=(-1);
  g1(10,7)=(-((1-params(5))*params(9)));
  g1(10,21)=1-(1-params(4))*params(1);
  ...
  g1(13,11)=1;
  g1(13,12)=1/(params(17)-params(18));
  g1(14,12)=(-0.5);
  g1(14,13)=1;
  g1(15,2)=(-(y(11)*(-(1-params(4)))));
  g1(15,5)=1;
  g1(15,11)=(-(y(18)-(1-params(4))*y(2)));
  g1(15,18)=(-y(11));
  g1(16,18)=(-(getPowerDeriv(y(18),(-params(20)),1)));
  g1(16,19)=1;
  g1(17,16)=(-y(19));
  g1(17,19)=(-y(16));
  g1(18,7)=1-(params(11)+1-params(11));
  g1(18,10)=(-x(1));
  g1(19,10)=1-params(12);
  g1(20,2)=(-(y(7)+y(13)));
  g1(20,7)=(-y(2));
  g1(20,9)=1;
  g1(20,13)=(-y(2));
  ...
  g1(21,17)=1;
  g1(21,23)=(-1);
  g1(22,7)=(-((1-params(5))*params(9)));
  g1(22,23)=1-(1-params(4))*params(1);
  g1(23,16)=(-params(1));
  g1(23,22)=1;
  g1(24,2)=(-1);
  g1(24,24)=1;
