...
%
% Plot comparison b/w stochastic and non-stochastic hiring 
%
...
load(fullfile('.', 'Inputs/', 'IRFs_SaMOptionValue_Uniform_NonStochastic_p05_sigmaa0001_Recalib'));
...
sPlotting.legend.labels{1} = 'Non-stochastic hiring';
sPlotting.legend.labels{2} = 'Stochastic hiring';
...
print(fig1,'Output\Figures\fig_App_sigmaa001_Recalib_NonStochasticHiring','-dpdf','-painters')
