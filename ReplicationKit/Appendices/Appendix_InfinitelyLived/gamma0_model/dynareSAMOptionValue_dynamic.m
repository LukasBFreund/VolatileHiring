...
T22 = y(8)^(1-params(3));
T166 = params(8)*getPowerDeriv(y(7),params(3),1);
T173 = getPowerDeriv(y(8),1-params(3),1);
lhs =y(7);
...
residual(7)= lhs-rhs;
lhs =y(21);
rhs =(1-params(5))*(params(9)*y(10)-params(7))+params(1)*((1-params(4))*y(29)+params(4)*y(28));
residual(8)= lhs-rhs;
lhs =y(18);
rhs =(1-params(5))*params(9)*y(16)/(1-(1-params(4))*params(1))+y(22);
residual(9)= lhs-rhs;
lhs =y(22);
rhs =(1-params(5))*(params(9)*y(10)-params(7))+params(1)*(params(4)*y(28)+(1-params(4))*y(30));
residual(10)= lhs-rhs;
lhs =y(19);
...
residual(19)= lhs-rhs;
lhs =y(24);
rhs =(1-params(5))*(params(9)*y(10)-params(7))+params(1)*(params(4)*y(28)+(1-params(4))*y(31));
residual(20)= lhs-rhs;
lhs =y(23);
rhs =params(1)*y(28);
residual(21)= lhs-rhs;
...
if nargout >= 4,
  ...
  v3(2,1)=2;
  v3(2,2)=7828;
  v3(2,3)=(-(T173*params(8)*getPowerDeriv(y(7),params(3),2)));
  v3(3,1)=2;
  v3(3,2)=6740;
  v3(3,3)=  v3(2,3);
  v3(4,1)=2;
  ...
  v3(5,1)=2;
  v3(5,2)=7861;
  v3(5,3)=(-(T166*getPowerDeriv(y(8),1-params(3),2)));
  v3(6,1)=2;
  v3(6,2)=6773;
  v3(6,3)=  v3(5,3);
  v3(7,1)=2;
