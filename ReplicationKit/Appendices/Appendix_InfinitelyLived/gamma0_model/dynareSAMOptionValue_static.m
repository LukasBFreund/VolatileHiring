...
T188 = (-((1-params(5))*params(9)/(1-(1-params(4))*params(1))));
lhs =y(4);
...
residual(7)= lhs-rhs;
lhs =y(18);
rhs =(1-params(5))*(params(9)*y(7)-params(7))+params(1)*((1-params(4))*y(18)+params(4)*y(16));
residual(8)= lhs-rhs;
lhs =y(15);
rhs =(1-params(5))*params(9)*y(13)/(1-(1-params(4))*params(1))+y(19);
residual(9)= lhs-rhs;
lhs =y(19);
rhs =(1-params(5))*(params(9)*y(7)-params(7))+params(1)*(params(4)*y(16)+(1-params(4))*y(19));
residual(10)= lhs-rhs;
lhs =y(16);
...
residual(19)= lhs-rhs;
lhs =y(21);
rhs =(1-params(5))*(params(9)*y(7)-params(7))+params(1)*(params(4)*y(16)+(1-params(4))*y(21));
residual(20)= lhs-rhs;
lhs =y(20);
rhs =params(1)*y(16);
residual(21)= lhs-rhs;
