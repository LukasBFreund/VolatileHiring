...
M_.endo_names = char(M_.endo_names, 'Gammma');
M_.endo_names_tex = char(M_.endo_names_tex, '{\Gamma}');
M_.endo_names_long = char(M_.endo_names_long, 'Measure of entrepreneurs making new draws');
M_.endo_names = char(M_.endo_names, 's');
M_.endo_names_tex = char(M_.endo_names_tex, '{\Gamma}');
M_.endo_names_long = char(M_.endo_names_long, 'Measure of unavailable entrepreneurs');
M_.endo_names = char(M_.endo_names, 'JUtilde');
M_.endo_names_tex = char(M_.endo_names_tex, '{\tilde{J}^U}');
M_.endo_names_long = char(M_.endo_names_long, 'Value of newly separated entrepreneur');
...
M_.equations_tags = {
  ...
  16 , 'name' , 'Measure of entrepreneurs with new draws' ;
  17 , 'name' , 'Measure of unavailable entrepreneurs' ;
  18 , 'name' , 'Value of newly separated entrepreneur' ;
  19 , 'name' , 'Aggregate productivity' ;
  20 , 'name' , 'Aggregate productivity volatility' ;
  21 , 'name' , 'Output' ;
  22 , 'name' , 'Value of matched entrepreneur at steady state cut-off level' ;
  24 , 'name' , 'Value of entrepreneur leaving without match' ;
};
...
M_.NNZDerivatives(2) = 32;
M_.NNZDerivatives(3) = 28;
...
save('Output\IRFs\IRFs_HetFirm_GammaModel_Spc', 'vEMAS', 'vNames', 'vNames_Andreasen', 'mIRFProp_zUncertainty_EMAS', 'mIRFProp_Andreasen_zVol_EMAS','mIRFProp_Andreasen_z_EMAS','mIRFProp_Andreasen_Order1_z_EMAS','mIRFProp_Order1_z_EMAS','mIRFProp_Andreasen_Order3_z_EMAS'); 
