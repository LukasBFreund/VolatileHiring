function [ys,check] = dynareSAMOptionValue_steadystate(ys,exo)
...
%% Enter model equations here
    ...
    JUtilde = (1-sPar.gamma)/(1-sPar.gamma*sPar.beta)*JU;
    
    JaHatPTilde = ((1-sPar.omega)*(sPar.xss*sPar.ss.z-sPar.chi)+sPar.beta*sPar.delta*JUtilde)/(1-sPar.beta*(1-sPar.delta));
